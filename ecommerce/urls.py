...
urlpatterns = [
    ...
    path('', views.mostrarProductos, name='mostrarProductos'),
    path('new', views.nuevoProducto, name='nuevoProducto'),
    path('modify/<int:id>', views.EditarProducto, name='EditarProducto'),
